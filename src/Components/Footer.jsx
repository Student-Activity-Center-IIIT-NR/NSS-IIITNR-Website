          ...
          <div className="flex flex-col space-y-6">
            <div className="flex flex-row items-center space-x-2">
              <div>
                ...
                >
                  <path
                    d="M24 12.875C24 21.3333 13 28.5833 13 28.5833C13 28.5833 2 21.3333 2 12.875C2 9.99077 3.15893 7.22467 5.22183 5.18521C7.28473 3.14576 10.0826 2 13 2C15.9174 2 18.7153 3.14576 20.7782 5.18521C22.8411 7.22467 24 9.99077 24 12.875Z"
                    stroke="black"
                    strokeWidth="2.5"
                    strokeLinecap="round"
            ...
            <div className="flex flex-row items-center space-x-2">
              <div>
                ...
                >
                  <path
                    d="M3.4 1H22.6C23.92 1 25 2.06875 25 3.375V17.625C25 18.9313 23.92 20 22.6 20H3.4C2.08 20 1 18.9313 1 17.625V3.375C1 2.06875 2.08 1 3.4 1Z"
                    stroke="black"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="flex flex-row items-center space-x-2">
              ...
              <a className="text-xl cursor-pointer" href="tel:99999999">
                +91-771-2474038
              </a>
            </div>
          </div>
